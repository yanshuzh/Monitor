...
void myrtprecv::checkerror(int rtperr)
{
    if (rtperr < 0)
    {
...
void myrtprecv::OnPollThreadStep()
{
    BeginDataAccess();
...
*/
void myrtprecv::ProcessRTPPacket(const RTPSourceData &srcdat,const RTPPacket &rtppack)
{
...
int myrtprecv::findheader(unsigned char *databuf,int len)
{
    int offset=0;
